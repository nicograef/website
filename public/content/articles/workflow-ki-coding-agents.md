...
jotti speichert jeden Verkauf als unveränderliches Event in einem Kassenjournal, signiert von einer Technischen Sicherheitseinrichtung (<abbr title="Technische Sicherheitseinrichtung">TSE</abbr>), wie es das deutsche Steuerrecht für elektronische Kassen verlangt. jotti nutzt dafür eine Cloud-TSE, kein lokales Stück Hardware. Bisher passierte die Signatur synchron im Kassier-Request: Wer auf „Kassieren“ tippte, wartete, bis die Cloud geantwortet hatte.
...
Nach der Umsetzung kommt der `/code-audit`-Skill, wieder in einer frischen Session. Für dieses Feature gab es einen eigenen, dedizierten Audit des ganzen Umbaus. Der prüft die Implementierung gegen den Plan, gegen die Rechtsquellen und über alle Schichten hinweg. Der frische Kontext ist hier der eigentliche Trick. Ein Reviewer, der den Code nicht selbst geschrieben hat, verteidigt ihn auch nicht.
