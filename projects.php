...
$freiburgChallenge = 'img/freiburg-challenge.jpg';
$whatTheFlag = 'img/what-the-flag.jpg';
$sudokuApp = 'img/sudoku-app.jpg';
$lokalrunde = 'img/lokalrunde.jpg';
$sudokuSolver = 'img/sudoku-solver.jpg';
$countryQuiz = 'img/country-quiz.jpg';
$wiwili = 'img/wiwili.png';
$classification = 'img/classification.jpg';
$kuunery = 'img/kuunery.jpg';
$makelangelo = 'img/makelangelo.jpg';
$project0742 = 'img/project0742.jpg';
$smartCoffee = 'img/smart-coffee.jpg';
$mshSportpferde = 'img/msh-sportpferde.jpg';
$wirkraft = 'img/wirkraft.jpg';
$tutorialRunner = 'img/tutorial-runner.jpg';
$boardGamesCommunityApp = 'img/board-games-community-app.jpg';
...
$project1->image = $freiburgChallenge;
...
$project3->image = $sudokuApp;
$project3->tags = ['Java', 'Android', 'Firebase'];
$project3->linkTitle = 'Github';
...
$project4->image = $lokalrunde;
$project4->tags = ['Hackathon', 'Angular JS', 'Firebase'];
$project4->linkTitle = 'Github';
...
$project5->image = $smartCoffee;
$project5->tags = ['Arduino', 'C++', '3D-Printing', 'Embedded'];
$project5->linkTitle = 'Video';
...
$project6->image = $tutorialRunner;
$project6->tags = ['Unreal Engine', 'C++', 'Game Dev'];
$project6->linkTitle = 'Video';
...
$project7->image = $boardGamesCommunityApp;
$project7->tags = ['Cordova', 'Framework7', 'Mockup', 'Prototype'];
$project7->linkTitle = 'Demo';
...
$project8->image = $sudokuSolver;
$project8->tags = ['Java', 'Desktop', 'Algorithms'];
$project8->linkTitle = 'Github';
...
$project10->image = $wirkraft;
$project10->tags = ['Vue JS', 'Cordova', 'Couch DB', 'Android'];
$project10->linkTitle = 'Website';
...
$project12->image = $makelangelo;
$project12->tags = ['Startup', 'Art'];
$project12->linkTitle = 'Video';
...
$project14->image = $project0742;
$project14->tags = ['Node JS', 'Web Design'];
$project14->linkTitle = 'Video';
