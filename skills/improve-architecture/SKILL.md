...
Use sub-agents to navigate the codebase naturally. Do NOT follow rigid
...
### 7. Write RFC document

Write a refactor RFC to `docs/rfcs/rfc-<name>.md` (create the directory if it
